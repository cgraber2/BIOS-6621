...
The following chunk of R code calculates the overall mean IQ, the mean IQ of subjects near the smelter, and the mean IQ of subjects far from the smelter. The mean IQ of subjects near the smelter and far from the smelter are displayed in a table created using knitr::kable(), as well as in a barplot.The distribution of IQ in subjects near and far from the smelter is displayed in a boxplot.
